...
conf = Rails.application.settings :devise
...
Devise.setup do |config|
  ...
  # :failed_attempts = Locks after a number of failed attempts to sign in.
  ...
  # :time  = Re-enables login after a certain amount of time (see below)
